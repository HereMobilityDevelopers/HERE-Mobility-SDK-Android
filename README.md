...
The HERE Mobility SDK version 2.0.74 supports Android version 4.1 (API level 16) or later.
...
dependencies{
	...
	implementation "com.here.mobility.sdk:demand:2.0.74"
	implementation "com.here.mobility.sdk:map:2.0.74"
}
```
