...
The HERE Mobility SDK version 1.1.42 supports Android version 4.0.4 (API level 15) or later.
...
dependencies{
	...
	implementation "com.here.mobility.sdk:demand:1.1.42"
	implementation "com.here.mobility.sdk:map:1.1.42"
}
```
